...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (spacemacs-theme shell-pop spacelin yasnippet whitespace-cleanup-mode which-key visual-regexp-steroids use-package try spaceline-all-the-icons solaire-mode smartparens simpleclip rainbow-mode rainbow-delimiters org-bullets org neotree hlinum helm general evil doom-themes)))
