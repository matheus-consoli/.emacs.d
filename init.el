...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (flyspell-correct-helm pdf-tools company-auctex latex-preview-pane auctex markdown-mode+ company-math markdown-mode markdown flycheck-rust rust-mode dumb-jump ein nyan-mode elpy font-lock+ company-quickhelp multi-term htmlize ox-reveal spacemacs-theme spacelin whitespace-cleanup-mode which-key visual-regexp-steroids use-package try spaceline-all-the-icons solaire-mode smartparens simpleclip rainbow-mode rainbow-delimiters org-bullets org neotree hlinum helm general evil doom-themes)))
