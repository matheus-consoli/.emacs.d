...
**** blame
     #+begin_src emacs-lisp
       (use-package blamer
         ...
         (blamer-face ((t :height ,(- (face-attribute 'default :height) 20)
                          :italic nil)))
...
** garbage collector magic hack
   #+begin_src emacs-lisp
     (use-package gcmh
       :custom (gcmh-high-cons-threshold (* 256 1024 1024))
       :config
...
** Modeline
   #+begin_src emacs-lisp
     ...
     (custom-set-faces
      '(mode-line ((t (:family "Monoid Nerd Font" :height 110))))
...
*** Load theme
    #+begin_src emacs-lisp
      ...
      (load-theme 'spacemacs-dark ;; 'doom-rouge ;; 'doom-feather-light ;; 'kaolin-breeze
                  :no-confirm)
    #+end_src
...
*** Italic comments
    #+begin_src emacs-lisp
      (custom-set-faces
       '(font-lock-comment-face ((t :font "Maple Mono Italic" :slant italic)))) ;; to set the font family, use the variable-pitch face-attribute (??)
    #+end_src
