    ...
    #+begin_src emacs-lisp
      (use-package lsp-ui
        ...
        (setq lsp-ui-doc-enable t
              ...
              ;; lsp-ui-doc-webkit-max-width-px 300 ;; default: 600
...
*** ts-movement
    #+begin_src emacs-lisp
      (use-package ts-movement
        ...
        :bind
        (:map ts-movement-map
              ("C-c . d" . 'tsm/delete-overlay-at-point)
              ("C-c . D" . 'tsm/clear-overlays-of-type)
              ("C-c . b" . 'tsm/node-prev)
              ("C-c . C-b" . 'tsm/backward-overlay)
              ("C-c . C-f" . 'tsm/forward-overlay)
              ("C-c . f" . 'tsm/node-next)
              ("C-c . p" . 'tsm/node-parent)
              ("C-c . n" . 'tsm/node-child)
              ("C-c . N" . 'tsm/node-children)
              ("C-c . s" . 'tsm/node-children-of-type)
              ("C-c . a" . 'tsm/node-start)
              ("C-c . e" . 'tsm/node-end)
      	("C-c . m" . 'tsm/node-mark)
              ("C-c . c" . 'tsm/mc/mark-all-overlays))
...
*** treesitter context
    #+begin_src emacs-lisp
      (use-package treesitter-context
        ...
        :custom
        (treesitter-context-show-context-always t) ;; only show when the outmost parent is invisible
        ...
        (treesitter-context-border-color (face-attribute 'default :frontend))
...
**** LSP config
     #+begin_src emacs-lisp
       (setq lsp-rust-analyzer-lru-capacity (* 10 128)
             ...
             lsp-rust-analyzer-expression-adjustment-hints-mode "always"
...
*** Set font
    #+begin_src emacs-lisp
      (set-face-attribute 'default nil
                          ...
                          :font "VictorMono Nerd Font" ;; "Martian Mono Std Lt" ;; "Monoid Nerd Font" ;; "Iosevka SS14" ;; "Iosevka Comfy Motion Duo" ;; "Baumans" ;; "CaskaydiaCove Nerd Font Propo"
                          :height 130)
...
*** Italic comments
    #+begin_src emacs-lisp
      (custom-set-faces
       '(font-lock-comment-face ((t :font "VictorMono Nerd Font" :slant italic)))) ;; to set the font family, use the variable-pitch face-attribute (??)
    #+end_src
*** Pretty symbols
    #+begin_src emacs-lisp
      (when window-system
