...
** custom set faces
   #+begin_src emacs-lisp
     (custom-set-faces
      '(mode-line ((t (:inherit 'default :family "Iosevka Consoli" :height 120 :box nil))))
      '(mode-line-active ((t (:inherit mode-line :family "Iosevka Consoli" :height 120 :box nil))))
      '(mode-line-inactive ((t (:inherit mode-line-active :family "Iosevka Consoli" :height 120 :box nil))))
