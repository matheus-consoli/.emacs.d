...
#+begin_src emacs-lisp
  (use-package timu-macos-theme
    :defer t
    :init (customize-set-variable 'timu-macos-flavour "light"))
#+end_src
*** loading theme
    #+begin_src emacs-lisp
...
** custom set faces
   #+begin_src emacs-lisp
     (custom-set-faces
      '(mode-line ((t (:inherit 'default :family "Mononoki Nerd Font" :height 130 :box nil))))
      ...
      '(blamer-face ((t :family "VictorMono Nerd Font" :height 120 :italic t)))
      ...
      '(font-lock-comment-face ((t :font "Maple Mono" :slant italic :height 130))))
...
** custom theme set faces
   #+begin_src emacs-lisp
     ...
     (custom-theme-set-faces
      'user
      '(fixed-pitch ((t (:family "VictorMono Nerd Font" :height 140))))
      '(variable-pitch ((t (:family "Margem Test" :height 160)))) ;; short stack
      '(org-block ((t (:inherit fixed-pitch))))
      '(org-code ((t (:inherit (shadow fixed-pitch)))))
      '(org-document-info-keyword ((t (:inherit (shadow fixed-pitch)))))
      '(org-indent ((t (:inherit (org-hide fixed-pitch)))))
      '(org-meta-line ((t (:inherit (font-lock-comment-face fixed-pitch)))))
      '(font-lock-doc-face ((t (:inherit font-lock-string-face :height 140))))
