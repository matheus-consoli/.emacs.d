        ...
        (setq org-roam-capture-templates
                     '(("u" "uncategorized" plain
                        ...
                        :target (file+head "%<%Y%m%d%H%M%S>-${slug}.org"
                                           "#+FILETAGS: :uncategorized #+TITLE: ${title}\n#+DATE: %U\n\n")
                        :unnarrowed t)))
      #+end_src
***** Book
      #+begin_src emacs-lisp 
...
** Modeline
   #+begin_src emacs-lisp
     ...
     (custom-set-faces
      '(mode-line ((t (:family "Iosevka Nerd Font" :height 110))))
...
*** Set font
    #+begin_src emacs-lisp
      (add-to-list 'default-frame-alist '(font . "Iosevka SS02")) ;; Iosevka SS02
      (set-face-attribute 'default t :font "Iosevka SS02")
