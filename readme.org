...
*** LSP mode
    #+begin_src emacs-lisp
      (use-package lsp-mode
        ...
        ;; automatically save buffers after renaming variable
...
#+begin_src emacs-lisp
  (use-package aidermacs
    ...
    (aidermacs-default-model "anthropic/claude-4-opus-20250514")
...
*** loading theme
    #+begin_src emacs-lisp
      ...
      (defvar my-gui-theme 'vercel-2024
        "The theme to use for graphical Emacs frames.")
      (defvar my-cli-theme 'kaolin-dark
