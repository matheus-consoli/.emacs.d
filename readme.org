...
#+begin_src emacs-lisp
  (use-package cognitive-complexity
    ...
    :config (cognitive-complexity-mode 1))
#+end_src
** Languages specifics
*** Rust
**** Rust mode
...
#+begin_src emacs-lisp
  (use-package centaur-tabs
    ...
    (centaur-tabs-change-fonts "VictorMono Nerd Font" 90)
    (centaur-tabs-mode t)
    :bind
   ...
   #+begin_src emacs-lisp
     (use-package doom-modeline
       ...
       (setq
        ...
        doom-modeline-icon t ;; remove icons
...
** custom set faces
   #+begin_src emacs-lisp
     (custom-set-faces
      '(mode-line ((t (:inherit 'default :family "Borg Sans Mono" :height 110 :box nil))))
     ...
     ;; customize the appearence of set-face-attribute; needs to be at runtime
