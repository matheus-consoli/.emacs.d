...
#+begin_src emacs-lisp
(setq
 lsp-rust-analyzer-rustfmt-override-command ["./build/$TARGET_TRIPLE/stage0/bin/rustfmt", "--edition=2021"]
...
*** Set font
#+begin_src emacs-lisp
  (add-to-list 'default-frame-alist '(font . "Monoid Nerd Font-11"))
  (set-face-attribute 'default t :font "Monoid Nerd Font")
